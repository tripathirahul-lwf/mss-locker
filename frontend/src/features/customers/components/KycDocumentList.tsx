      ...
      {isLoading ? (
        ...
        customerKycStatus === 'VERIFIED' ? (
          <div className="space-y-4">
            ...
            {/* Clean, Subtle Digital Upload Prompt */}
            {canManageKyc && (
              <div className="bg-white border border-dashed border-slate-300 hover:border-emerald-500 rounded-2xl p-4 sm:p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h5 className="text-xs font-semibold text-slate-900">
                      Upload Digital Scans (Optional)
                    </h5>
                    <p className="text-[11.5px] text-slate-500 font-normal mt-0.5">
                      Attach scanned copies of Aadhaar, PAN, Passport, or specimen cards for digital archival.
                    </p>
                  </div>
                </div>
                ...
                <Button
                  size="sm"
                  onClick={onAddDocument}
                  className="h-8.5 px-3.5 bg-slate-900 hover:bg-slate-800 text-white text-xs font-medium rounded-xl shrink-0 cursor-pointer shadow-xs gap-1.5"
                >
