    ...
    <div className="bg-white border border-slate-200/90 rounded-2xl shadow-xs overflow-hidden flex flex-col">
      ...
      <div className="hidden lg:block overflow-x-auto min-h-[320px]">
        <table className="w-full text-left text-xs border-collapse">
          ...
          {/* Table Header */}
          <thead className="bg-slate-50/95 border-b border-slate-200 text-slate-500 font-medium tracking-wider text-[11px] uppercase sticky top-0 z-10 backdrop-blur-sm">
            <tr>
              <th
                aria-sort={sortDirection('fullName')}
                className="py-3 px-4"
              >
                <button type="button" onClick={() => onSortChange('fullName')} className="group flex items-center gap-1.5 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-700 cursor-pointer hover:text-slate-800">
              ...
              <th
                ...
                className="py-3 px-3"
              >
                <button type="button" onClick={() => onSortChange('phone')} className="group flex items-center gap-1.5 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-700 cursor-pointer hover:text-slate-800">
              ...
              <th
                ...
                className="py-3 px-3"
              >
                <button type="button" onClick={() => onSortChange('kycStatus')} className="group flex items-center gap-1.5 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-700 cursor-pointer hover:text-slate-800">
                  <span>KYC Compliance</span>
                  {renderSortIcon('kycStatus')}
                </button>
              </th>
              <th
                ...
                className="py-3 px-3"
              >
                <button type="button" onClick={() => onSortChange('status')} className="group flex items-center gap-1.5 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-700 cursor-pointer hover:text-slate-800">
              ...
              >
                <button type="button" onClick={() => onSortChange('createdAt')} className="group ml-auto flex items-center justify-end gap-1.5 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-700 cursor-pointer hover:text-slate-800">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="space-y-0.5 min-w-0">
                        ...
                        <button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            handleCopyCode(customer._id, customer.customerCode);
                          }}
                          className="group/code inline-flex items-center gap-1 text-[10.5px] font-sans bg-slate-100/90 hover:bg-slate-200/80 border border-slate-200 text-slate-600 hover:text-slate-900 font-medium px-1.5 py-0.5 rounded-md tabular-nums tracking-normal transition-colors cursor-pointer"
                          title="Click to copy Customer Code"
                          aria-label={`Copy customer code ${customer.customerCode}`}
                        >
                          <span>{customer.customerCode}</span>
                          {copiedCodeId === customer._id ? (
                            <Check className="w-2.5 h-2.5 text-emerald-600" />
                          ) : (
                            <Copy className="w-2.5 h-2.5 text-slate-400 opacity-0 group-hover/code:opacity-100 transition-opacity" />
                          )}
                        </button>
                      </div>
                    </div>
                    ...
                    {customer.assignedLockers && customer.assignedLockers.length > 0 ? (
                      <div className="space-y-0.5">
                        ...
                        <div className="text-[11px] text-slate-500 font-normal pl-0.5">
                          ...
                          {customer.assignedLockers[0].rackNumber && ` • ${customer.assignedLockers[0].rackNumber.toLowerCase().startsWith('rack') ? customer.assignedLockers[0].rackNumber : `Rack ${customer.assignedLockers[0].rackNumber}`}`}
                      ...
                      <div className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md bg-slate-100 border border-slate-200 text-slate-500 text-[11px] font-normal">
